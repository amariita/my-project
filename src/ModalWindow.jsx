        ...
        style={{display: isVisible}} onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div style={{ display: "flex"}}>
                    <a href="http://t.me/atirama" target="_blank" className="social-button">
                        <span className="social telegram" />  
                            Telegram
                    </a>
                    <a href="https://vk.com/ama.riita" target="_blank" className="social-button">
                        <span className="social vkontakte" />  
                            Vkontakte
                    </a>
                </div>
            </div>
